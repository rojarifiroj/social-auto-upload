...
watermark_text_top = "SleepyKitty"  # Watermark text in top-left corner
watermark_text_bottom_1 = "猫咪呼噜声"  # Black text with white border part 1
watermark_text_bottom_2 = "&舒缓音乐"  # Black text with white border part 2
...
for image_name in os.listdir(input_folder):
    if image_name.endswith(('jpg', 'jpeg', 'png')):  # Process images of specified formats
        ...
        font_size_top = int(width / 10)  # Top-left corner font size is 1/10 of image width
        font_size_bottom = int(width / 15)  # Bottom middle part font is slightly smaller
        ...
        # Position of bottom middle watermark
        ...
        padding = 10  # Inner padding of rectangle
        ...
        for char in watermark_text_bottom_1:
            ...
            x += draw.textlength(char, font_bottom)  # Update x position
